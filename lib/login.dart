          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildTextField(controller: _emailController, label: 'Email/Username'),
                _buildTextField(controller: _passwordController, label: 'Kata Sandi', obscureText: true),
                Align(
                  alignment: Alignment.centerRight,
                  child: TextButton(
                    onPressed: () {},
                    child: const Text('Lupa kata sandi?', style: TextStyle(color: Color(0xFF777785))),
                  ),
                ),
                ...
                Center(
                  child: Row(
                    ...
                    children: [
                      const Text('Belum memiliki akun?', style: TextStyle(color: Color(0xFF777785))),
                      TextButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                        ...
                        child: const Text(
                          'Daftar',
                          style: TextStyle(color: Color(0xFFB6252A), fontWeight: FontWeight.bold),
                        ),
                      ),
                    ],
                  ),
