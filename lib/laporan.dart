...
import 'buatlaporandb.dart'; // Import file buatlaporandb.dart
...
class _LaporanPageState extends State<LaporanPage> {
  ...
  final LaporanDB laporanDB = LaporanDB(); // Inisialisasi objek LaporanDB
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              _buildToggleButtons("Buat Sebagai Anonim", ["Iya", "Tidak"],
                  (val) {
                setState(() => selectedAnonim = val);
              }, selectedAnonim),
              SizedBox(height: 10),
              _buildToggleButtons("Laporkan Sebagai", ["Korban", "Saksi"],
                  (val) {
              ...
              _buildTextField("Deskripsi", deskripsiController,
                  maxLines: 3, borderColor: Colors.red),
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  // Memastikan semua data sudah terisi
                  if (selectedAnonim != null &&
                      selectedStatus != null &&
                      selectedDate != null &&
                      deskripsiController.text.isNotEmpty &&
                      lokasiController.text.isNotEmpty) {
                    // Panggil fungsi saveLaporan untuk menyimpan data ke Firebase
                    await laporanDB.saveLaporan(
                      deskripsi: deskripsiController.text,
                      lokasi: lokasiController.text,
                      anonim: selectedAnonim!,
  ...
  Widget _buildToggleButtons(String title, List<String> options,
      Function(String) onSelected, String? selectedValue) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
              ...
              child: Padding(
                ...
                child: OutlinedButton(
                  style: OutlinedButton.styleFrom(
                    backgroundColor:
                        isSelected ? Color(0xFFED1E28) : Colors.white,
                    foregroundColor:
                        isSelected ? Colors.white : Color(0xFFED1E28),
  ...
  Widget _buildTextField(String label, TextEditingController controller,
      {int maxLines = 1, Color borderColor = Colors.grey}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
          ...
          child: Container(
            ...
            child: Center(
              child: uploadedFile == null
                  ...
                  : Text(uploadedFile!, style: TextStyle(color: Colors.grey)),
            ),
          ),
        ),
      ],
